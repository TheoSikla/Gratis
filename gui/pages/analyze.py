...
from conf.base import ANALYZE_PAGE_MAIN_LABEL_TEXT, ANALYZE_PAGE_SELECT_FILE_TYPE_LABEL_TEXT, \
...
from conf.styles import MAIN_FRAME_BACKGROUND, BUTTON_FONT, FRAME_BACKGROUND, LABEL_BACKGROUND, LABEL_FONT_LARGE, \

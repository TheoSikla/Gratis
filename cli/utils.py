...
def handle_graph_creation(args):
    if args.model == GraphType.HOMOGENEOUS.value:
        Homogeneous(args.graph_representation).create_homogeneous_graph(number_of_vertices=args.number_of_vertices)
    elif args.model == GraphType.ER.value:
        ErdosRenyi(args.graph_representation).create_er_graph(number_of_vertices=args.number_of_vertices,
                                                              probability=args.probability,
                                                              seed=args.seed)
    elif args.model == GraphType.CUSTOM_ER.value:
        ErdosRenyi(args.graph_representation).create_custom_er_graph(number_of_vertices=args.number_of_vertices,
                                                                     number_of_edges=args.number_of_edges,
                                                                     probability=args.probability,
                                                                     seed=args.seed)
    elif args.model == GraphType.RANDOM_FIXED.value:
        RandomFixed(args.graph_representation).create_random_fixed_graph(number_of_vertices=args.number_of_vertices,
        ...
        if not args.number_of_initial_nodes:
            ...
            ScaleFreePA(args.graph_representation).create_scale_free_graph(number_of_vertices=args.number_of_vertices,
                                                                           seed=args.seed)
        else:
            # Full Scale Free with Preferential Attachment and Incremental Growth
            FullScaleFree(args.graph_representation).create_full_scale_free_graph(
                number_of_vertices=args.number_of_vertices,
                number_of_initial_nodes=args.number_of_initial_nodes,
                seed=args.seed)
        ...
        if args.number_of_edges:
            ...
            ScaleFreePA(args.graph_representation).create_custom_scale_free_graph(
                number_of_vertices=args.number_of_vertices,
                number_of_edges=args.number_of_edges,
                seed=args.seed)
